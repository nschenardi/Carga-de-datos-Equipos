...
function initApp() {
  ...
  document.getElementById("btn-whatsapp").addEventListener("click", function() {
    alert("Función enviar WhatsApp pendiente de implementar");
  });

  document.getElementById("btn-email").addEventListener("click", function() {
    alert("Función enviar Email pendiente de implementar");
  });
}
  ...
  if(tipo === "Tanque") {
    ...
    if(foto) {
      ...
      reader.onload = function(e) {
        ...
        doc.save(`Informe_${tipo}_${new Date().toISOString()}.pdf`);
      };
